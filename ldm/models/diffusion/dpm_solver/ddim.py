...
class DDIMSampler(object):
    def __init__(self, model, schedule="linear", device=torch.device("cuda"), **kwargs):
        ...
        self.device = device
        self.timesteps_file = 'custom_timesteps.txt'
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True):
        ...
        # custom_timesteps = [0, 16, 33, 51, 77, 106, 130, 148, 163, 179, 198, 221, 240, 265, 287, 306, 326, 348, 373, 395, 414, 434, 449, 467, 488, 509, 528, 549, 568, 587, 606, 627, 647, 665, 684, 705, 723, 743, 766, 786, 805, 825, 853, 878, 901, 921, 935, 944, 960, 998]
        # self.ddim_timesteps= np.array(custom_timesteps)
        ...
        # self.ddim_timesteps = optimized_indices
        # print(f"ddim_timesteps0:{self.optimized_timesteps}")
        # print(f"ddim_timesteps:{self.ddim_timesteps}")
        class_name = self.__class__.__name__
        function_name = sys._getframe().f_code.co_name
        print(f"Executing {function_name} in class {class_name}")

        if os.path.exists(self.timesteps_file):
